...
if ( ! class_exists( 'GBT_InstallWizard' ) ) {
	class GBT_InstallWizard {
		...
		public function setupWizard() {
			...
			$default_steps = array(
				'introduction' => array(
					'name'    => esc_html__( 'Introduction', 'the-hanger' ),
		...
		public function gbt_setup_introduction() {
			?>
				<div class="wrapper wizard-introduction">
					...
					<h1><?php printf(esc_html__( '%s \'s', 'the-hanger'), GBTHELPERS::theme_name());?> <br/> <?php esc_html_e('Theme Setup Wizard', 'the-hanger' ); ?></h1>
			...
			?>
				<div class="wrapper wizard-plugins">
					...
					<div class="content-info">
						...
						<p><?php esc_html_e( 'Install the required plugins before importing the demo content.', 'the-hanger' ); ?></p>
					</div>
					...
					<ul class="plugins">
						...
						<li class="recommended">
							<h3><?php esc_html_e( 'Recommended', 'the-hanger' ); ?></h3>
						</li>
		...
		public function _get_plugins_list( $plugins, $required ) {
			foreach ( $plugins as $slug => $plugin ) {
				if ( isset($plugin['demo_required']) && $plugin['demo_required'] === $required ) : ?>
					<li class="plugin <?php echo esc_attr( $slug ); ?>">
						...
						<label for="<?php echo esc_attr($plugin['slug']); ?>" class="<?php echo ( isset($plugin['demo_required']) && $plugin['demo_required'] === true ) ? 'required' : 'optional' ?>">
							...
							<div class="plugin-description-container">
								...
								<p><?php echo isset( $plugin['description'] )? esc_html_e( $plugin['description'], 'the-hanger' ) : ''; ?></p>
							</div>
							...
							<div class="plugin-install">
								...
								<?php if ( ! empty( $plugin['status'] ) && ($plugin['status'] != 'no-action') ) : ?>
										<a  class="button ajax-request <?php echo esc_html( $plugin['status'] ); ?>-now"
											...
											<?php echo ( isset($plugin['status']) && $plugin['status'] == 'install' ) ? esc_html_e( 'Install Now', 'the-hanger' ) : ''; ?>
											<?php echo ( isset($plugin['status']) && $plugin['status'] == 'update' ) ? esc_html_e( 'Update Now', 'the-hanger' ) : ''; ?>
											<?php echo ( isset($plugin['status']) && $plugin['status'] == 'activate' ) ? esc_html_e( 'Activate', 'the-hanger' ) : ''; ?>
										</a>
					...
					<div class="column last">
						...
						<ul>
							...
							<li>
								...
								?>
								<a href="<?php echo esc_url($activate); ?>">
							...
							<li><a href="<?php echo GBTHELPERS::support_link(); ?>" target="_blank"><span class="dashicons dashicons-editor-help"></span><?php esc_html_e( 'Theme Documentation', 'the-hanger' ); ?></a></li>
						</ul>
					</div>
				</div>
